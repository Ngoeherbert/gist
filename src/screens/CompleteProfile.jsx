...
export default function CompleteProfile({ navigation }) {
  ...
  const {
    ...
    email: storedEmail = "",
    emailVerified: storedEmailVerified = false,
    phone: storedPhone = "",
  ...
  const [showBirthdayModal, setShowBirthdayModal] =
    useState(false);

  const [birthdayDate, setBirthdayDate] = useState(
    storedBirthday
      ? new Date(storedBirthday)
      : new Date(2000, 0, 1),
  );
  ...
  const handleContinue = () => {
    ...
    // Save the complete profile before navigation.
  ...
  const handleChoosePhoto = () => {
    /*
     * Photo picker can be connected here later.
     *
     * Example future flow:
     *
  ...
  const handleBirthdayDone = () => {
    const formatted = formatBirthday(birthdayDate);
    ...
    try {
      ...
      try {
        ...
        if (address.length > 0) {
          ...
          const readable = `${latitude.toFixed(
            5,
          )}, ${longitude.toFixed(5)}`;
          ...
          <View style={styles.form}>
            ...
            <View style={styles.header}>
              ...
              <Text style={styles.description}>
                Add a few details so people can recognize
            ...
            <View style={styles.phoneSection}>
              ...
              {phone.trim() ? (
                <View style={styles.phoneHint}>
                  ...
                  <Text
                    style={styles.phoneHintText}
                  >
                    We'll send a verification code by
                    SMS.
                  </Text>
                </View>
              ) : null}
